(function(angular){
    ...
    app.controller('ForumCtrl', ['$scope', '$routeParams', '$http', '$location', 'Category', 'Contracts', 'Forum', 'Tag', 'Topic', 'TopicPage', 'CurrentUser',
        function ($scope, $routeParams, $http, $location, Category, Contracts, Forum, Tag, Topic, TopicPage, CurrentUser) {
            function normalInit() {
                $scope.filters = {};
